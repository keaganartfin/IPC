...
const CrmContacts = () => {
  ...
  useEffect(() => {
    ...
    // Assuming `crmcontacts` is expected to be an array
  }, [crmcontacts]);

  // Conditional rendering or data access
  useEffect(() => {
    // Ensure `crmcontacts` is not undefined before accessing `.length`
  ...
  document.title = "Contacts | Insulation Products Corporation";
  return (
    <React.Fragment>
