  ...
  const productCategory = [
    {
      options: [
        { label: "All", value: "All" },
        { label: "Heat Shrink Tubing", value: "Heat Shrink Tubing" },
        { label: "Non-Shrink Tubing", value: "Non-Shrink Tubing" },
        { label: "Non-Metallic Conduit Tubing", value: "Non-Metallic Conduit Tubing" },
        { label: "Non-Metallic Conduit Connectors & Couplings", value: "Non-Metallic Conduit Connectors & Couplings" },
        { label: "Adhesives", value: "Adhesives" },
        { label: "Heat Shrink Tape", value: "Heat Shrink Tape" },
        { label: "Heat Gun", value: "Heat Gun" },
        { label: "Value Added Products", value: "Value Added Products" },
        { label: "Hot Stamp Marking", value: "Hot Stamp Marking" },
        { label: "Tubing Kits", value: "Tubing Kits" },
      ],
    },
  ];
