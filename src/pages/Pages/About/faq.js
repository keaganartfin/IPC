                ...
                <Col xxl={5} className="align-self-center">
                  <div className="py-4">
                    ...
                    <p className="text-success fs-15 mt-3">
                      ...
                      you can always contact us or email us. We will answer you
                      shortly!
                    </p>
                  ...
                  <div className="accordion-item shadow">
                    ...
                    <Collapse isOpen={col1} className="accordion-collapse">
                      <div className="accordion-body">
                        ...
                        Markers, Kitting, Special Requests we typically ship in
                        1 – 2 weeks.
                      </div>
                    </Collapse>
                  </div>
                  ...
                  <div className="accordion-item shadow">
                    ...
                    <Collapse isOpen={col10} className="accordion-collapse">
                      <div className="accordion-body">
                        ...
                        certification or a signed certification if requested.
                      </div>
                    </Collapse>
                  </div>
                  <div className="accordion-item shadow">
                    <h2 className="accordion-header" id="privacy-headingThree">
                      <button
                        ...
                        style={{ cursor: "pointer" }}
                      >
                        What MIL-SPEC can you certify your marking process to?
                      </button>
                    </h2>
                    <Collapse isOpen={col11} className="accordion-collapse">
                      <div className="accordion-body">
                        We can certify our Hot Stamp Marking process to
                        MIL-STD-130, MIL-M-81531 (Permanency), MIL-M-60903 (Hot
                        Stamp Only) and MIS-39598.
                      </div>
                    </Collapse>
                  </div>
                  <div className="accordion-item shadow">
                    ...
                    <Collapse isOpen={col12} className="accordion-collapse">
                      <div className="accordion-body">
                        We stock over 25 million feet of tubing so we are able
                        to service our customers with quick deliveries.
                      </div>
                    </Collapse>
                  </div>
                </div>
                ...
                >
                  <div className="accordion-item shadow">
                    <h2 className="accordion-header" id="privacy-headingOne">
                      <button
                        ...
                        style={{ cursor: "pointer" }}
                      >
                        What is the difference between Melt Wall Polyolefin and
                    ...
                    <Collapse isOpen={col13} className="accordion-collapse">
                      <div className="accordion-body">
                        ...
                        flows and encapsulates. Adhesive Lined Polyolefin has an
                        inner melfaqTable wall that flows and adheres.
                      </div>
                    </Collapse>
                  </div>
                  <div className="accordion-item shadow">
                    ...
                    <Collapse isOpen={col14} className="accordion-collapse">
                      <div className="accordion-body">
                        Allow shrinkable tubing to recover at least 20% to avoid
                        splitting. Be sure to use a heat-gun at the proper
                        suggested temperature and always use a reflector on the
                        heat-gun for even heat dispersion. Either too much heat
                        or improperly distributed heat is usually the cause of
                        split tubing, especially PVC.
                      </div>
                    </Collapse>
                  </div>
                  <div className="accordion-item shadow">
                  ...
                  <div className="accordion-item shadow">
                    <h2 className="accordion-header" id="privacy-headingFour">
                      <button
                        ...
                        style={{ cursor: "pointer" }}
                      >
                        Why does my Marked image seem smaller after I shrink the
                        tubing?
                      </button>
                    </h2>
                  ...
                  <div className="accordion-item shadow">
                    <h2 className="accordion-header" id="privacy-headingFour">
                      <button
                        ...
                        style={{ cursor: "pointer" }}
                      >
                        If I have a flat width in Inches, how do I figure out
                        the inner diameter?
                      </button>
                    </h2>
                  ...
                  <div className="accordion-item shadow">
                    ...
                    <Collapse isOpen={col18} className="accordion-collapse">
                      <div className="accordion-body">
                        Layflat PVC is measured by flat width in millimeters.
                      </div>
                    </Collapse>
                  </div>
                </div>
