...
//Small Images
import pdfPath from "../../../../assets/images/pdfs/IP35KY.pdf" 
import LeftSideTables from "../../About/LeftSideTables";

const HeatShrinkKynar = () => {
            ...
            <Col lg={12}>
              <Row>
                <Col xxl={9}>
                  <Card>
                    <CardBody>
                    <h5>Heat Shrinkable Kynar</h5>
                      <iframe
                        src={pdfPath}
                        style={{ width: "100%", height: "1150px" }}
                        frameBorder="0"
                        title="Heat Shrinkable Kynar"
                      >
...
export default HeatShrinkKynar;
