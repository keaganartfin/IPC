...
//Small Images
import pdfPath from "../../../../assets/images/pdfs/IP53MP.pdf";
import LeftSideTables from "../../About/LeftSideTables";

const HeatShrinkMedicalGradePoly = () => {
                  ...
                  <Card>
                    <CardBody>
                      <iframe
                        ...
                        frameBorder="0"
                        title="Heat Shrinkable Medical Grade Tubing"
                      >
...
export default HeatShrinkMedicalGradePoly;
