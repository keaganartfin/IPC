              ...
              <div>
                ...
                <TabContent activeTab={activeTab} className="pt-4">
                                        ...
                                        <div className="accordion-item border-0">
                                          ...
                                          >
                                            <div className="accordion-body ms-2 ps-5">
                                              <Row className="g-2">
                                                <div className="col-auto">
                                                  <div className="d-flex border border-dashed p-2 rounded position-relative shadow">
                                                    <div className="flex-shrink-0">
                                        ...
                                        <div className="accordion-item border-0">
                                          ...
                                          >
                                            ...
                                            >
                                              <div className="d-flex">
                                                <div className="flex-shrink-0 avatar-xs">
                                                  <div className="avatar-title bg-light text-muted rounded-circle shadow">
                  ...
                  <TabPane tabId="2">
                    <Card>
                      <CardBody>
                        <h5 className="card-title mb-3">FAQs</h5>
                        ...
                        <Row>
                          {(projects || []).map((item, key) => (
                            <Col xxl={3} sm={6} key={key}>
                              <Card
                                className={`profile-project-card profile-project-${item.cardBorderColor}`}
                              >
